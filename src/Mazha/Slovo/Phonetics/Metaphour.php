...
namespace Mazha\Slovo\Phonetics;
...
class Metaphour {
    ...
    public function endingCompression ($SLOVO) {
        if (!$this->endingCompressionReplacer) {
            $this->endingCompressionReplacer = new \Mazha\Slovo\Utils\Replacer($this->endingsCompressionTable);
        }
    ...
    public function vowelsSimpling ($SLOVO) {
        if (!$this->vowelsSimplingReplacer) {
            $this->vowelsSimplingReplacer = new \Mazha\Slovo\Utils\Replacer($this->vowelsSimplingTable);
        }
    ...
    public function flumping ($SLOVO) {
        ...
        if (!$this->flumpingReplacer)
        {
            ...
            $refTable['_'] = '';
            $this->flumpingReplacer = new \Mazha\Slovo\Utils\Replacer($refTable);
        }
